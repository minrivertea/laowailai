...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cities_blog', (
            ...
            ('last_checked', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 9, 21, 7, 51, 54, 360344))),
        ))
    ...
    models = {
        'cities.blog': {
            ...
            'last_checked': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 21, 7, 51, 54, 360344)'}),
