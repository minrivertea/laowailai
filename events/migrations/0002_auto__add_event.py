...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_event', (
            ...
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 12, 18, 35, 36, 698470))),
    ...
    models = {
        ...
        'events.event': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 12, 18, 35, 36, 698470)'}),
