...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NewEvent.added_by'
        db.delete_column('events_newevent', 'added_by_id')


    def backwards(self, orm):
        
        # Adding field 'NewEvent.added_by'
        db.add_column('events_newevent', 'added_by', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['list.Laowai']), keep_default=False)
    ...
    models = {
        ...
        'events.event': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 12, 18, 37, 24, 362095)'}),
