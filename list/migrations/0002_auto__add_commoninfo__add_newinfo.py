...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CommonInfo'
        db.create_table('list_commoninfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['list.Laowai'], null=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True)),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cities.City'], null=True)),
        ))
        db.send_create_signal('list', ['CommonInfo'])

        # Adding model 'NewInfo'
        db.create_table('list_newinfo', (
        ...
        db.send_create_signal('list', ['NewInfo'])


    def backwards(self, orm):
        
        # Deleting model 'CommonInfo'
        db.delete_table('list_commoninfo')

        # Deleting model 'NewInfo'
        db.delete_table('list_newinfo')
    ...
    models = {
        ...
        'list.photo': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 4, 21, 44, 26, 204970)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'places.place': {
            ...
            'chinese_name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cities.City']"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 4, 21, 44, 26, 204032)'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitude': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
