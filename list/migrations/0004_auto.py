...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field cities on 'Laowai'
        db.create_table('list_laowai_cities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('laowai', models.ForeignKey(orm['list.laowai'], null=False)),
            ('city', models.ForeignKey(orm['cities.city'], null=False))
        ))
        db.create_unique('list_laowai_cities', ['laowai_id', 'city_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field cities on 'Laowai'
        db.delete_table('list_laowai_cities')
    ...
    models = {
        ...
        'list.photo': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 11, 5, 46, 34, 563024)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'places.place': {
            ...
            'chinese_name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cities.City']"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 11, 5, 46, 34, 562052)'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitude': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
