...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('list_photo', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='content_type_set_for_photo', to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'Photo.object_pk'
        db.add_column('list_photo', 'object_pk', self.gf('django.db.models.fields.TextField')(default=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.content_type'
        db.delete_column('list_photo', 'content_type_id')

        # Deleting field 'Photo.object_pk'
        db.delete_column('list_photo', 'object_pk')
    ...
    models = {
        ...
        'list.photo': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 12, 2, 57, 14, 80126)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'places.place': {
            ...
            'chinese_name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cities.City']"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 12, 2, 57, 14, 79158)'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitude': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
