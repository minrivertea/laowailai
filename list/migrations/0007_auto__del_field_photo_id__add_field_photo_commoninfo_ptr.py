...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('list_photo', 'id')

        # Adding field 'Photo.commoninfo_ptr'
        db.add_column('list_photo', 'commoninfo_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=2, to=orm['list.CommonInfo'], unique=True, primary_key=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Photo.id'
        db.add_column('list_photo', 'id', self.gf('django.db.models.fields.AutoField')(default=2, primary_key=True), keep_default=False)

        # Deleting field 'Photo.commoninfo_ptr'
        db.delete_column('list_photo', 'commoninfo_ptr_id')
