...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('list_photo', 'image', self.gf('django.db.models.fields.files.ImageField')(default=2, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.image'
        db.delete_column('list_photo', 'image')
