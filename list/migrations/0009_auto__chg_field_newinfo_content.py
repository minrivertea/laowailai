...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewInfo.content'
        db.alter_column('list_newinfo', 'content', self.gf('django.db.models.fields.TextField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'NewInfo.content'
        db.alter_column('list_newinfo', 'content', self.gf('django.db.models.fields.TextField')())
