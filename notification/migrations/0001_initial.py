...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notification_notice', (
            ...
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='content_type_set_for_notice', to=orm['contenttypes.ContentType'])),
    ...
    models = {
        ...
        'notification.notice': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'content_type_set_for_notice'", 'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
