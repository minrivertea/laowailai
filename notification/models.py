...
class Notice(models.Model):
    ...
    # added by me, because a notification should have a related object, right?
...
def send_now(users, label, extra_context=None, on_site=True, sender=None, content_type=None, object_pk=None):
    """
    ...
    for user in users:
        ...
        notice = Notice.objects.create(recipient=user, message=messages['notice.html'],
            notice_type=notice_type, on_site=on_site, sender=sender, object_pk=object_pk, 
