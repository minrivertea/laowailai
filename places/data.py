...
def find_places(q=None, skip_photoless=False, city=None,
                default_find_all=False, split_searchterm=False, qs=None,
                **parameters):
    """return an queryset of Places by searching the core frock. 
    ...
    if q is not None:
        ...
        if not split_searchterm:
            qset = Q(name__icontains=q) | \
                Q(chinese_name__iexact=q) | \
