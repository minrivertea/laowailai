...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        from laowailai.list.models import CommonInfo, Laowai
        ...
        for place in orm.Place.objects.all():
            ...
            new_object = orm.NewPlace.objects.create(
                name=place.name,
                ...
                rating_total=place.rating_total,
                category=place.category,
                owner=place.added_by,
                city=place.city,
                date=place.date_added,
            )
            new_object.save()
    ...
    models = {
        ...
        'places.place': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 4, 23, 58, 22, 514018)'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitude': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
