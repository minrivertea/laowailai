...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field verified_by on 'NewPlace'
        db.create_table('places_newplace_verified_by', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('newplace', models.ForeignKey(orm['places.newplace'], null=False)),
            ('laowai', models.ForeignKey(orm['list.laowai'], null=False))
        ))
        db.create_unique('places_newplace_verified_by', ['newplace_id', 'laowai_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field verified_by on 'NewPlace'
        db.delete_table('places_newplace_verified_by')
    ...
    models = {
        ...
        'places.newplace': {
            ...
            'verified': ('django.db.models.fields.IntegerField', [], {'default': "'0'"}),
            'verified_by': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['list.Laowai']", 'null': 'True', 'blank': 'True'})
        },
        'places.place': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 20, 22, 56, 47, 21736)'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitude': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
