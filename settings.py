...
AUTH_PROFILE_MODULE = "list.Laowai"
...
# this is undocumented, but it stops the commenting system 
# from filtering profanities (which suffer from the Scunthorpe Problem)
